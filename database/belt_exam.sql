...
-- -----------------------------------------------------
-- Table `belt_exam`.`magazines`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `belt_exam`.`magazines` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_magazines_users_idx` (`creator_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `belt_exam`.`users_has_magazines`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `belt_exam`.`users_has_magazines` (
  ...
  CONSTRAINT `fk_users_has_magazines_magazines1`
    ...
    REFERENCES `belt_exam`.`magazines` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
